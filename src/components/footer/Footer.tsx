          ...
          <div className="col-md-6 col-lg-3">
            <div className="footer-contact">
              ...
              <div className="footer-social">
                <Link href="#" className="m-1"><FaTwitter /></Link>
                <Link href="#" className="m-1"><FaFacebookF /></Link>
                <Link href="#" className="m-1"><FaYoutube /></Link>
                <Link href="#" className="m-1"><FaInstagram /></Link>
                <Link href="#" className="m-1"><FaLinkedinIn /></Link>
              </div>
            </div>
          </div>
